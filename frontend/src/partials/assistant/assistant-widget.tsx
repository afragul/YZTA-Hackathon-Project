    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 size-40 rounded-full bg-transparent flex items-center justify-center hover:scale-110 active:scale-95 transition-transform"
